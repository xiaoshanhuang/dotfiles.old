...
def search_for(lang, query):
    args = {'action': 'query', 'list': 'search', 'srsearch': query, "srprop": "timestamp|snippet", 'format': 'json', 'redirects':''}
...
def get_content(item):
    return item['snippet'].replace("<span class='searchmatch'>","").replace("</span>","").replace("<b>...</b>","...")
    # return 'Read about ' + item['title'] + ' on ' + lang + '.wikipedia.org'
