%-- Unknown date --%
('type', 'bcg', 'latency', peakLoc(i)-50, 'urevent', [], 'duration', []); end;
eeg.event
EEG.event
EEG.event(1).channel
...
load('eegdata_face.mat')
help GraphicalLasso
[w] = GraphicalLasso(pop, lambda);
[A,S,z] = SIM(eegdata(1).data);
figure, topoplot(A(:,1), eegdata(1).chanlocs)
figure, topoplot(A(:,2), eegdata(1).chanlocs)
figure, topoplot(A(:,3), eegdata(1).chanlocs)
figure, topoplot(A(:,4), eegdata(1).chanlocs)
plot(z(1,:))
plot(z(2,:))
plot(z(3,:))
imagesc(eegdata(1).data(:,:)*eegdata(1).data(:,:)')
[w] = GraphicalLasso(eegdata(1).data(:,:), 0.5);
%-- 12/24/13, 12:26 AM --%
load('eegdata_face.mat')
[w] = GraphicalLasso(eegdata(1).data(:,:)', 0.5);
mex glasso.F
...
figure, topoplot(A(:,3), eegdata(1).chanlocs)
figure, topoplot(A(:,4), eegdata(1).chanlocs)
figure, topoplot(A(:,5), eegdata(1).chanlocs)
figure, topoplot(A(:,10), eegdata(1).chanlocs)
[A,S,z] = SIM(eegdata(1).data);
figure, topoplot(A(:,1), eegdata(1).chanlocs)
figure, topoplot(A(:,2), eegdata(1).chanlocs)
figure, topoplot(A(:,3), eegdata(1).chanlocs)
...
plot(z)
plot(z')
[A,S,z] = rSIM(eegdata(1).data);
erp = rSIM(eegdata(1).data);
[erp, ECovSigAll] = rSIM(eegdata(1).data);
temp = reshape(ECovSigAll, [60*60, 50]);
help ttest
H = ttest(temp)
H = ttest(temp');
find(H==1)
...
[erp, ECovSigAll] = rSIM(eegdata(1).data);
temp = reshape(ECovSigAll, [60*60, 50]);
temp = reshape(ECovSigAll, [60*60, 100]);
H = ttest(temp', 0, 'alpha', 0.001);
sum(H>0)
H = ttest(temp', 0, 'alpha', 0.05);
sum(H>0)
ECovSig = mean(ECovSigAll,3);
H = ttest(temp', 0, 'alpha', 0.001);
H = reshape(H, [60,60]);
imagesc(ECovSig)
imagesc(ECovSig.*H)
[W,D]=eig(ECovSig);[Q,I]=sort(diag(D),'descend');
sum(Q>0)
[erp, ECovSigAll, ECovResAll] = rSIM(eegdata(1).data);
for i = 1:100 imagesc(ECovResAll); pause; end;
for i = 1:100 imagesc(ECovResAll(:,:,i)); pause; end;
temp = reshape(ECovSigAll, [60*60, 100]);
boxplot(temp)
plot(mean(temp,2))
boxplot(temp)
...
imagesc((ECovSig))
imagesc(inv(ECovSig))
for i = 1:100 imagesc(inv(ECovResAll(:,:,i))); pause; end;
for i = 1:100 imagesc(inv(ECovSigAll(:,:,i))); pause; end;
for i = 1:100 imagesc(inv(ECovResAll(:,:,i))); pause; end;
for i = 1:100 imagesc((ECovResAll(:,:,i))); pause; end;
[erp, ECovSigAll, ECovResAll] = rSIM(eegdata(1).data);
for i = 1:100 imagesc((ECovResAll(:,:,i))); pause; end;
...
imagesc(w)
imagesc(inv(w))
C = eegdata(1).data(:,:)*eegdata(1).data(:,:)';
imagesc(inv(C))
imagesc(C)
[w] = GraphicalLasso(eegdata(1).data(:,:)', 0.1);
help GraphicalLasso
[w,theta] = GraphicalLasso(eegdata(1).data(:,:)', 0.1); imagesc(theta)
for i = 1:10, [w,theta] = GraphicalLasso(eegdata(1).data(:,:)', 0.1*i); imagesc(theta); pause; end
for i = 1:10, [w,theta] = GraphicalLasso(eegdata(1).data(:,:)', 0.1*i); imagesc(w); pause; end
[w,theta] = GraphicalLasso(eegdata(1).data(:,:)', 0.1); imagesc(theta)
imagesc(inv(C))
[w,theta] = GraphicalLasso(eegdata(1).data(:,:)', 0.1); imagesc(theta)
for i = 1:20, [w,theta] = GraphicalLasso(eegdata(1).data(:,:)', 0.1*i); imagesc(theta); pause; end
for i = 1:10, [w,theta] = GraphicalLasso(eegdata(1).data(:,:)', 0.01*i); imagesc(theta); pause; end
[A,S,z] = rSIM(eegdata(1).data);
[A,S,z] = SIM(eegdata(1).data);
plot(z(1,:))
z1 = z;
...
figure, topoplot(A(:,3), eegdata(1).chanlocs);
figure, topoplot(A(:,4), eegdata(1).chanlocs);
figure, topoplot(A1(:,4), eegdata(1).chanlocs);
figure, topoplot(A1(:,1), eegdata(1).chanlocs);
figure, topoplot(A1(:,2), eegdata(1).chanlocs);
figure, topoplot(A1(:,3), eegdata(1).chanlocs);
figure, topoplot(A1(:,4), eegdata(1).chanlocs);
[A,S,z] = SIM(eegdata(1).data);
figure, topoplot(A(:,1), eegdata(1).chanlocs);
figure, topoplot(A(:,2), eegdata(1).chanlocs);
figure, topoplot(A(:,3), eegdata(1).chanlocs);
plot([z(1,:); z1(1,:)]')
for i = 1:10, [w,theta] = GraphicalLasso(eegdata(1).data(:,:)', 0.001*i); imagesc(theta); pause; end
for i = 1:10, [w,theta] = GraphicalLasso(eegdata(1).data(:,:)', 0.01*i); imagesc(theta); pause; end
for i = 1:10, [w,theta] = GraphicalLasso(eegdata(1).data(:,:)', 0.01*i); sum(sum(theta==0)) end;
for i = 1:10, [w,theta] = GraphicalLasso(eegdata(1).data(:,:)', 0.01*i); sparse(i) = sum(sum(theta==0)); end;
sparse
for i = 1:10, [w,theta] = GraphicalLasso(eegdata(1).data(:,:)', 0.1*i); sparse(i) = sum(sum(theta==0)); end;
sparse
for i = 1:10, [w,theta] = GraphicalLasso(eegdata(1).data(:,:)', 1*i); sparse(i) = sum(sum(theta==0)); end;
sparse
for i = 1:10, [w,theta] = GraphicalLasso(eegdata(1).data(:,:)', 10*i); sparse(i) = sum(sum(theta==0)); end;
sparse
[A,S,z] = SIM(eegdata(1).data);
plot(z(1,:))
plot([z(1,:); z1(1,:)]')
...
figure, topoplot(A(:,4), eegdata(1).chanlocs);
figure, topoplot(A(:,5), eegdata(1).chanlocs);
figure, topoplot(A(:,6), eegdata(1).chanlocs);
figure, topoplot(A(:,7), eegdata(1).chanlocs);
[A,S,z] = SIM(eegdata(1).data);
figure, topoplot(A(:,1), eegdata(1).chanlocs);
plot([z(1,:); z1(1,:)]')
help GraphicalLasso
for i = 1:10, [A,S,z] = sSIM(eegdata(1).data,i*100); z_all(:,:,i) = z; end;
figure, plot(z_all(1,:,:))
figure, plot(squeeze(z_all(1,:,:)))
for i = 1:10, [A,S,z] = sSIM(eegdata(1).data,i*10); z_all(:,:,i) = z; end;
figure, plot(squeeze(z_all(1,:,:)))
figure, topoplot(A(:,1), eegdata(1).chanlocs);
figure, topoplot(A(:,2), eegdata(1).chanlocs);
for i = 1:10, [A,S,z] = sSIM(eegdata(2).data,i*10); z_all(:,:,i) = z; end;
figure, plot(squeeze(z_all(1,:,:)))
figure, plot(squeeze(z_all(2,:,:)))
figure, plot(squeeze(z_all(3,:,:)))
figure, plot(squeeze(z_all(1,:,:)))
figure, plot(squeeze(z_all(1,:,10)))
for i = 1:10, [A,S,z] = sSIM(eegdata(2).data,i*10); z_all(:,:,i) = z; end;
[A,S,z] = SIM(eegdata(1).data); [A,S,zs] = sSIM(eegdata(1).data,i*10); for i = 1:6, subplot(2,3,i), plot([z(i,:); zs(i,:)]'); end;
[A,S,z] = SIM(eegdata(1).data); [A,S,zs] = sSIM(eegdata(1).data,100); for i = 1:6, subplot(2,3,i), plot([z(i,:); zs(i,:)]'); end;
[A,S,z] = SIM(eegdata(2).data); [A,S,zs] = sSIM(eegdata(2).data,100); for i = 1:6, subplot(2,3,i), plot([z(i,:); zs(i,:)]'); end;
[A,S,z] = SIM(eegdata(3).data); [A,S,zs] = sSIM(eegdata(3).data,100); for i = 1:6, subplot(2,3,i), plot([z(i,:); zs(i,:)]'); end;
[A,S,z] = SIM(eegdata(1).data); [A,S,zs] = sSIM(eegdata(1).data,200); for i = 1:6, subplot(2,3,i), plot([z(i,:); zs(i,:)]'); end;
[A,S,z] = SIM(eegdata(1).data); [A,S,zs] = sSIM(eegdata(1).data,800); for i = 1:6, subplot(2,3,i), plot([z(i,:); zs(i,:)]'); end;
[A,S,z] = SIM(eegdata(1).data); [A,S,zs] = sSIM(eegdata(1).data,100); for i = 1:6, subplot(2,3,i), plot([z(i,:); zs(i,:)]'); end;
[A,S,z] = SIM(eegdata(1).data); [A,S,zs] = sSIM(eegdata(1).data,1); for i = 1:6, subplot(2,3,i), plot([z(i,:); zs(i,:)]'); end;
[A,S,z] = SIM(eegdata(1).data); [A,S,zs] = sSIM(eegdata(1).data,10000); for i = 1:6, subplot(2,3,i), plot([z(i,:); zs(i,:)]'); end;
[A,S,z] = SIM(eegdata(1).data); [A,S,zs] = sSIM(eegdata(1).data,10); for i = 1:6, subplot(2,3,i), plot([z(i,:); zs(i,:)]'); end;
[A,S,z] = SIM(eegdata(1).data); [A,S,zs] = sSIM(eegdata(1).data,1); for i = 1:6, subplot(2,3,i), plot([z(i,:); zs(i,:)]'); end;
[A,S,z] = SIM(eegdata(1).data); [A,S,zs] = sSIM(eegdata(1).data,100); for i = 1:6, subplot(2,3,i), plot([z(i,:); zs(i,:)]'); end;
[A,S,z] = SIM(eegdata(1).data); [A,S,zs] = sSIM(eegdata(1).data,10000); for i = 1:6, subplot(2,3,i), plot([z(i,:); zs(i,:)]'); end;
[A,S,z] = SIM(eegdata(1).data); [A,S,zs] = sSIM(eegdata(1).data,10000); for i = 1:6, subplot(2,3,i), plot(zscore([z(i,:); zs(i,:)]')); end;
[A,S,z] = SIM(eegdata(1).data); [A,S,zs] = sSIM(eegdata(1).data,100); for i = 1:6, subplot(2,3,i), plot(zscore([z(i,:); zs(i,:)]')); end;
[A,S,z] = SIM(eegdata(3).data); [A,S,zs] = sSIM(eegdata(3).data,100); for i = 1:6, subplot(2,3,i), plot(zscore([z(i,:); zs(i,:)]')); end;
[A,S,z] = SIM(eegdata(4).data); [A,S,zs] = sSIM(eegdata(4).data,100); for i = 1:6, subplot(2,3,i), plot(zscore([z(i,:); zs(i,:)]')); end;
[A,S,z] = SIM(eegdata(5).data); [A,S,zs] = sSIM(eegdata(5).data,100); for i = 1:6, subplot(2,3,i), plot(zscore([z(i,:); zs(i,:)]')); end;
[A,S,z] = SIM(eegdata(6).data); [A,S,zs] = sSIM(eegdata(6).data,100); for i = 1:6, subplot(2,3,i), plot(zscore([z(i,:); zs(i,:)]')); end;
[A,S,z] = SIM(eegdata(6).data); [A,S,zs] = sSIM(eegdata(6).data,50); for i = 1:6, subplot(2,3,i), plot(zscore([z(i,:); zs(i,:)]')); end;
data = eegdata(1).data - repmat(mean(eegdata(1).data(:,1:20,:),2), [1, 100, 1]);
[A,S,z] = SIM(data); [A,S,zs] = sSIM(data,50); for i = 1:6, subplot(2,3,i), plot(zscore([z(i,:); zs(i,:)]')); end;
[A,S,z] = SIM(data); [A,S,zs] = sSIM(data,100); for i = 1:6, subplot(2,3,i), plot(zscore([z(i,:); zs(i,:)]')); end;
data = eegdata(2).data - repmat(mean(eegdata(2).data(:,1:20,:),2), [1, 100, 1]);
[A,S,z] = SIM(data); [A,S,zs] = sSIM(data,100); for i = 1:6, subplot(2,3,i), plot(zscore([z(i,:); zs(i,:)]')); end;
data = eegdata(3).data - repmat(mean(eegdata(3).data(:,1:20,:),2), [1, 100, 1]);
[A,S,z] = SIM(data); [A,S,zs] = sSIM(data,100); for i = 1:6, subplot(2,3,i), plot(zscore([z(i,:); zs(i,:)]')); end;
[A,S,z] = SIM(data); [A,S,zs] = sSIM(data,100); for i = 1:6, subplot(2,3,i), plot(([z(i,:); zs(i,:)]')); end;
data = eegdata(4).data - repmat(mean(eegdata(4).data(:,1:20,:),2), [1, 100, 1]);
[A,S,z] = SIM(data); [A,S,zs] = sSIM(data,100); for i = 1:6, subplot(2,3,i), plot(([z(i,:); zs(i,:)]')); end;
data = eegdata(2).data - repmat(mean(eegdata(2).data(:,1:20,:),2), [1, 100, 1]);
[A,S,z] = SIM(data); [A,S,zs] = sSIM(data,100); for i = 1:6, subplot(2,3,i), plot(([z(i,:); zs(i,:)]')); end;
data = eegdata(3).data - repmat(mean(eegdata(3).data(:,1:20,:),2), [1, 100, 1]);
