...
plot(EEG.data)
fftplot(EEG.data, EEG.srate, [0.5 30])
fftplot(EEG.data(1,1001:3000), EEG.srate, [0.5 30])
fftplot(EEG.data(1,10001:12000), EEG.srate, [0.5 30])
fftplot(EEG.data(1,11001:12000), EEG.srate, [0.5 30])
fftplot(EEG.data(1,11001:13000), EEG.srate, [0.5 30])
fftplot(EEG.data(1,13001:14000), EEG.srate, [0.5 30])
fftplot(EEG.data(1,13001:15000), EEG.srate, [0.5 30])
fftplot(EEG.data(1,13001:16000), EEG.srate, [0.5 30])
fftplot(EEG.data(1,13001:23000), EEG.srate, [0.5 30])
fftplot(EEG.data(1,13001:33000), EEG.srate, [0.5 30])
fftplot(EEG.data(1,13001:33000), EEG.srate, [0.5 50])
fftplot(EEG.data(1,13001:33000), EEG.srate, [0.5 80])
fftplot(EEG.data(1,13001:33000), EEG.srate, [0.5 30])
fftplot(EEG.data(1,23001:33000), EEG.srate, [0.5 30])
fftplot(EEG.data(1,13001:33000), EEG.srate, [0.5 30])
eeglab
%-- 12/25/13, 4:43 PM --%
eeglab
fftplot(EEG.data(9,13001:33000), EEG.srate, [0.5 30])
fftplot(EEG.data(9,13001:33000), EEG.srate, [0.5 50])
fftplot(EEG.data(9,10001:33000), EEG.srate, [0.5 50])
fftplot(EEG.data(9,:), EEG.srate, [0.5 50])
fftplot(EEG.data(9,23001:33000), EEG.srate, [0.5 50])
fftplot(EEG.data(9,23001:33000), EEG.srate, [0.5 30])
fftplot(EEG.data(9,33001:43000), EEG.srate, [0.5 30])
%-- 12/25/13, 5:14 PM --%
eeglab
fftplot(EEG.data(1,13001:23000), EEG.srate, [0.5 30])
fftplot(EEG.data(1,13001:15000), EEG.srate, [0.5 30])
fftplot(EEG.data(1,15001:17000), EEG.srate, [0.5 30])
%-- 12/25/13, 10:08 PM --%
eeglab
clear all; close all; clc;
