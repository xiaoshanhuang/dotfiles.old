...
eeglab
eeglab redraw
figure, erpimage(bcgEEG(20,:), [], [-200 700 EEG.srate], [], 1, 1, 'erp', 'cbar', 'erp_grid', 'erpalpha', 0.01);
figure, erpimage(bcgEEG(20,:,:), [], [-200 700 EEG.srate], [], 1, 1, 'erp', 'cbar', 'erp_grid', 'erpalpha', 0.01);
figure, erpimage(bcgEEG(20,:,:), [], [-100 1000 EEG.srate], [], 1, 1, 'erp', 'cbar', 'erp_grid', 'erpalpha', 0.01);
c0 = squeeze(mean(bcgEEG(20,:,:), 3));
c0 = find(squeeze(mean(bcgEEG(20,:,:), 3))==0);
c0 = find(squeeze(mean(bcgEEG(20,:,:), 3)) == 0);
c0 = squeeze(mean(bcgEEG(20,:,:), 3));
plot(c0)
help sign
...
(326-282)/2
(326-282)/4
P1 = squeeze(mean(bcgEEG(20, 293:315, :),3));
plot(P1)
P1 = squeeze(mean(bcgEEG(20, 293:315, :),2));
plot(P1)
range = 326:398;
range = range(length(range)/4:3*length(range)/4);
range = range(length(range)/4:round(3*length(range)/4));
range = range(round(length(range)/4):round(3*length(range)/4));
range = 326:398;
range = range(round(length(range)/4):round(3*length(range)/4));
N1 = squeeze(mean(bcgEEG(20, range, :),2));
plot(N1)
corr(zscore(P1), zscore(N1))
plot([zscore(P1) zscore(N1)])
std(P1)
std(N1)
mean(P1)
mean(N1)
figure, erpimage(bcgEEG(30,:,:), [], [-100 1000 EEG.srate], [], 1, 1, 'erp', 'cbar', 'erp_grid', 'erpalpha', 0.01);
figure, erpimage(bcgEEG(13,:,:), [], [-100 1000 EEG.srate], [], 1, 1, 'erp', 'cbar', 'erp_grid', 'erpalpha', 0.01);
figure, erpimage(bcgEEG(19,:,:), [], [-100 1000 EEG.srate], [], 1, 1, 'erp', 'cbar', 'erp_grid', 'erpalpha', 0.01);
figure, erpimage(bcgEEG(21,:,:), [], [-100 1000 EEG.srate], [], 1, 1, 'erp', 'cbar', 'erp_grid', 'erpalpha', 0.01);
figure, for i = 1:31,  erpimage(bcgEEG(i,:,:), [], [-100 1000 EEG.srate], [], 1, 1, 'erp', 'cbar', 'erp_grid', 'erpalpha', 0.01); end;
help erpimage
figure, chan = 21; erpimage(bcgEEG(chan,:,:), [], [-100 1000 EEG.srate], [], 1, 1, 'erp', 'cbar', 'erp_grid', 'erpalpha', 0.01, 'topo', ALLEEG(snEEGReref).chanlocs(chan));
figure, chan = 21; erpimage(bcgEEG(chan,:,:), [], [-100 1000 EEG.srate], [], 1, 1, 'erp', 'cbar', 'erp_grid', 'erpalpha', 0.01, 'topo', {chan, ALLEEG(snEEGReref).chanlocs, []});
figure, for chan = 1:31, erpimage(bcgEEG(chan,:,:), [], [-100 1000 EEG.srate], [], 1, 1, 'erp', 'cbar', 'erp_grid', 'erpalpha', 0.01, 'topo', {chan, ALLEEG(snEEGReref).chanlocs, []}); pause; clf; end;
java.lang.Runtime.getRuntime.freeMemory
rangePeak = 1:size(bcg,2);
rangeChan = 1:32;
rangeTrial = 1:size(bcg,3);
