...
plot(EEG.data(4,:)')
%-- 12/20/13, 9:06 PM --%
tic; for i = 1:200, [V,D] = eig(rand(64,64)); end; toc
tic; for i = 1:5000, [V,D] = eig(rand(64,64)); end; toc
tic; for i = 1:5000, [V,D] = eig(ones(64,64)); end; toc
tic; for i = 1:5000, [V,D] = eig(rand(64,64)); end; toc
matlab pool
matlabpool
tic; parfor i = 1:5000, [V,D] = eig(rand(64,64)); end; toc
tic; [V,D] = eig(rand(10000, 10000)); toc
%-- 12/20/13, 9:29 PM --%
tic; [V,D] = eig(rand(2000, 2000)); toc
test = rand(2000,2000);
tic; [V,D] = eig(test); toc
matlabpool
tic; parfor i = 1:5000, [V,D] = eig(rand(128,128)); end; toc
test = rand(128, 128);
tic; parfor i = 1:5000, [V,D] = eig(test); end; toc
data = rand(64, 600000);
test = data'*data;
%-- 12/21/13, 11:12 AM --%
face_scene
